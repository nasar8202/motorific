...
@section('title','view Block Dealers List')
@section('secton')
<header class="mb-3">
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Dealers</h3>
                <p class="text-subtitle text-muted">View All Block Dealer List</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Block Dealers</li>
                    </ol>
                </nav>
            </div>
        </div>

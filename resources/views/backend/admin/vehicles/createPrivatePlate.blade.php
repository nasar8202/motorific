    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Private Plate</h3>
                <p class="text-subtitle text-muted">Create Private Plate</p>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-sm-0">
                    <h4 class="card-title">Add Private Plate Form</h4>
                </div>
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('storePrivatePlate') }}" method="POST" enctype="multipart/form-data" class="oveflow-x-scroll p-0">
                                    @csrf
                                    @if ($errors->any())

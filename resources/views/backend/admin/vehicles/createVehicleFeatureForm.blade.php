    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Vehicles Featuers</h3>
                <p class="text-subtitle text-muted">Create Vehicles Features</p>
            </div>
...
<script type="text/javascript">
    ...
    $("#dynamic-ar").click(function () {
        ...
        $("#dynamicAddRemove").append('<tr><td><input type="text" name="addMoreInputFields[' + i +
            '][title]" placeholder="Enter Title" class="form-control" /></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Remove </button></td></tr>'
            );
    });

                ...
                <div class="col-lg-9">
                    <div class="sec-2-txt pb-4">
                        ...
                        <div class="category-btn">
                            ...
                            <a href="{{ route('buyItNow') }}"
                                class="abcd {{ request()->IS('dealer/buy-it-now') ? 'active' : '' }}">Buy It Now</a>
                            <a href="{{ route('dealerToDealer') }}">Dealer To Dealer</a>
                        </div>
                        <h4 class="count">Showing {{ $countbuyItNoVehicle }} vehicles</h4>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="p-content">
                                                    ...
                                                    <h5 class="p-price">Buy it now:
                                                        <span>£{{ $vehicle->reserve_price }}</span>
                                                    </h5>
                                                    @if(isset($vehicle->highestOffer->request_price) )
                                                    <h5 class="p-price">Highest Offer:
                                                        <span>£{{$vehicle->highestOffer->request_price ?? ''}}</span>
                                                    </h5>
                                                    @endif
                                                </div>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#dropdownfilter').on('change', function() {
                ...
                $.ajax({
                    ...
                    url: 'buyItNowVehicledDropdownfilter',
                    type: 'post',
                    headers: {
                        ...
                        if (count > 0) {
                            ...
                            $.each(resultData, function(resultData, row) {
                                ...
                                bodyData +=
                                    ...
                                    row.vehicle_year + '</li><li>' + row
                                    .vehicle_mileage + '</li><li>' + row.vehicle_type +
                                    '</li><li>' + row.vehicle_tank +
                                    '</li> </ul><div class="p-cate-list"><span class="p-code gold">' +
                                    row.vehicle_registartion_number +
                                    '</span><span class="p-location"> <i class="fas fa-map-marker-alt"></i> 161 Mi away</span></div><h5 class="p-price">Reserve price: <span >$' +
                                    row.vehicle_price + '</span></h5></div>'
                                bodyData += '</div> </a></div>'

                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <form action="{{ route('updatePrivatePlate',$editPrivatePlate->id) }}" method="POST" enctype="multipart/form-data" class="oveflow-x-scroll p-0">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <table class="table table-bordered tables_admin_data " id="dynamicAddRemove">
                                        ...
                                        <tr>
                                            <td><input type="text" name="title" placeholder="Enter Title" value="{{ $editPrivatePlate->title }}" class="form-control w-160" />
                                            </td>

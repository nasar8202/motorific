                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          @else
                            ...
                            @endif
                            <td>@if(count($vehicle->allorder))Total Bids : {{ count($vehicle->allorder)}}@else No Bid Yet @endif</td>
                            <td>
                                <a href="{{ route('orderRequest',$vehicle->id) }}" class="cvf_btn"><span class="badge bg-success">View All Bids</span></a>

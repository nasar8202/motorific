                    ...
                    <form method="POST" action="{{route('updateMyProfile',$currentUser->id)}}">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{$currentUser->name}}"  placeholder="Full Name">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="post_code" class="form-control"  value="{{$currentUser->post_code}}" placeholder="7500,7200,etc">
                      ...
                      @endif
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="phone_number" class="form-control"  value="{{$currentUser->phone_number}}" placeholder="+44 01548544">
                    ...
                    <form method="POST" action="{{route('updateMyPassword',$currentUser->id)}}">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" name="current_pass" class="form-control"  placeholder="Enter Your Old Password">

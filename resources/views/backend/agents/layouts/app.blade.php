...
<head>
    ...
    <title>Motorific Agents - @yield('title')</title>
...
<body>
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="{{ route('dashboard') }}"><img src="{{URL::asset('frontend/seller/assets/image/logo.png')}}" alt="Logo" srcset=""></a>
                        </div>
                        <div class="toggler">
        ...
        <div id="main">
           @yield('secton')
            <footer>
                @include('backend.agents.partials._footer')
            </footer>
        </div>
    </div>
    <script>

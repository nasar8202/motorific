                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12 vehicleDetailLeft">
                        ...
                        <div class="titleVehicle">
                            ...
                            <p>{{ $vehicle->vehicle_color }}.<span>{{ $vehicle->vehicle_year }}</span><span>.</span>{{ $vehicle->vehicle_mileage }}<span>.</span>{{ $vehicle->vehicle_tank }}<span>.</span>{{ $vehicle->vehicle_type }}
                            </p>
                        </div>

                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('storeNumberOfKeys') }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <table class="table table-bordered" id="dynamicAddRemove">
                                        ...
                                        <tr>
                                            <td><input type="number" name="addMoreInputFields[0][number_of_key]" placeholder="Enter Number Of Keys" class="form-control" />
                                            </td>

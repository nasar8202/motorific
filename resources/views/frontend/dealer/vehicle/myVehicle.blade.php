                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Search in Complete" name="search"
                                    class="form-control search-retailers" id="search">
                                <br>
                                <p class="vehiclesCount" id="vehiclesCount"><span class="spanResult"
                        ...
                        success: function(data) {
                            ...
                            if (data['dealerVehicles'] != null && data['dealerVehicles'] !=
                                ...
                                jQuery.each(data['dealerVehicles'], function(i) {
                                        if (data['dealerVehicles'][i].status == 2) {
                                            var status = "Deactivate";
                                        } else if (data['dealerVehicles'][i].status == 1) {
                                            var status = "Approved";
                                        } else {
                                            var status = "Pending";
                                        }

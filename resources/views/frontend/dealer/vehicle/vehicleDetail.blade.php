...
@endif
                        <div class="reserveDetail vehicle">
                           ...
                           if($bid == null && $order == null){
                            ...
                            <center class="info_txt mb-2"><span class="info_txt text-center ">Your max bid for this vehicle is <span class="userRequestedPrice" > {{$order->request_price}} </span></span>
                            </center>   

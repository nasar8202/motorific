    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add LogBook Question</h3>
                <p class="text-subtitle text-muted">Add LogBook Question</p>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-sm-0">
                    <h4 class="card-title">Add LogBook Question</h4>
                </div>
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('storeLogBook') }}" method="POST" class="oveflow-x-scroll p-0">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <table class="table table-bordered tables_admin_data" id="dynamicAddRemove">
                                        <tr>
                                            <th>LogBook Question Title</th>
                                            <th>Action</th>
                                        </tr>
                                        <tr>
                                            <td><input type="text" name="addMoreInputFields[0][title]" placeholder="Enter LogBook Question" class="form-control w-160" />
                                            </td>

...
@section('secton')
    ...
    <div class="page-heading">
        ...
        <div class="form-group col-md-4">
            <form class="form" method="get" action="{{ route('findVehicleForOldUser', $user->id) }}">
                @csrf
                <input type="text" id="email-id-column" class="form-control" name="registeration"
        ...
        <br>
        <form class="form" method="post" action="{{ route('StoreVehicleByAdminForOldUser', $user->id) }}"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="location"
                                                    placeholder="Enter Your Postal Code" id="search" value="{{ old('location') }}">
                        ...
                        <div class="col-12 p-0">
                            <div class="card">
                                ...
                                <div class="row  align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ URL::asset('/frontend/seller/assets/image/add-p-back.png') }} "
                                            id="preview-image2" width="250px" height="250px"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ URL::asset('/frontend/seller/assets/image/add-p-back-corner.png') }} "
                                            id="preview-image3" width="250px" height="250px"
                                            class="rounded mx-auto d-block">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3 px-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ URL::asset('/frontend/seller/assets/image/add-p-interior.png') }}"
                                            id="preview-image4" width="250px" height="250px"
                                            class="rounded mx-auto d-block">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3 px-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ URL::asset('/frontend/seller/assets/image/add-p-dashboard.png') }} "
                                            id="preview-image5" width="250px" height="250px"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 px-3">
                                            ...
                                            <input class="form-control" type="file" id="image5" name="image5"
                                                accept="image/png, image/jpeg, image/jpg"0>
                                        </div>
